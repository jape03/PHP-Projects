            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    if (isset($_POST['action'])) {
                            ...
                            if ($result && mysqli_num_rows($result) > 0) {
                                ...
                                if ($password === $row['password']) {
                                    ...
                                    if ($row['access_level'] == 'Admin') {
                                        ...
                                        echo "<div class='error-message'><p>Access Denied: Unknown access level. Please fill out all required fields.</p></div>";
                                    }
                                } else {
                                    echo "<div class='error-message'><p>Invalid user ID or password.</p></div>";
                                }
                            } else {
                                echo "<div class='error-message'><p>Invalid user ID or password.</p></div>";
                            }
                        ...
                        echo "<div class='error-message'><p>No action specified.</p></div>";
                    }
                }
                ?>
