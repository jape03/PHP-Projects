...
<body>
    <div class="main">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <input type="text" id="first_name" name="first_name" value="<?php echo isset($_COOKIE['first_name']) ? htmlspecialchars($_COOKIE['first_name']) : ''; ?>" <?php echo isset($_SESSION['start_time']) && !empty($_COOKIE['first_name']) ? 'readonly style="background-color: #e9e9e9;"' : ''; ?>>
            
            <label for="middle_name">Middle Name:</label>
            <input type="text" id="middle_name" name="middle_name" value="<?php echo isset($_COOKIE['middle_name']) ? htmlspecialchars($_COOKIE['middle_name']) : ''; ?>" <?php echo isset($_SESSION['start_time']) && !empty($_COOKIE['middle_name']) ? 'readonly style="background-color: #e9e9e9;"' : ''; ?>>
            
            <label for="last_name">Last Name:</label>
            <input type="text" id="last_name" name="last_name" value="<?php echo isset($_COOKIE['last_name']) ? htmlspecialchars($_COOKIE['last_name']) : ''; ?>" <?php echo isset($_SESSION['start_time']) && !empty($_COOKIE['last_name']) ? 'readonly style="background-color: #e9e9e9;"' : ''; ?>>
